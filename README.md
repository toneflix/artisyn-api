...
To contribute to this project, please read the [Documentation](specs) and proceed to check out the available issues, if find one you can resolve, make something awesome and open a pull request.
